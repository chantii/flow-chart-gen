...
;(function() {
	...
	var jsPlumbInstance = function(_defaults) {
		 ...
		 * They are what will be used if you do not supply specific pieces of information to the various API calls. 
		 * A convenient way to implement your own look and feel can be to override these defaults by including a script 
		 * somewhere after the jsPlumb include, but before you make any calls to jsPlumb, for instance 
		 * in this example we set the PaintStyle to be a blue line of 27 pixels: > 
		...
		this.Defaults = {
			...
			LabelStyle : { fillStyle : "rgba(0,0,0,0)", color : "red" },
			LogEnabled : true,
			MaxConnections : null,
			MouseEventsEnabled : true, 
			// TODO: should we have OverlayStyle too?
			PaintStyle : { lineWidth : 10, strokeStyle : 'green' },
		...
		var EventGenerator = function() {
		    ...
		    this.mousedown = function(e) {
		    	if(self._over(e) && !_mouseDown) {
		    		...
		    		if (self.savePosition) self.savePosition();		    				    		
		    	}
		    };
...
/**
		 ...
		 * looking for. Valid values are: 
		 * scope this may be a String or a list of Strings. jsPlumb will only return Connections whose scope matches
		 * what this option defines. If you omit it, you will be given
		 * Connections of every scope. 
		 * 
		 *     source may be a string or a list of strings; constrains results to have only Connections whose source is
		 * this object. 
		 * 
		 *     target may be a string or a list of strings; constrains results to have only Connections whose target is this object.
		 * 
